...
def get_config():
    ...
    parser.add_argument('--version', type=str, default='BNCAGAN-FiveK', help='BNCAGAN')
    ...
    parser.add_argument('--pretrained_model', type=float, default=150.0)
    ...
    # Directories.
    parser.add_argument('--train_img_dir', type=str, default='./fivek/train')
    parser.add_argument('--val_img_dir', type=str, default='./fivek/val')
    parser.add_argument('--test_img_dir', type=str, default='./fivek/test')
    parser.add_argument('--save_root_dir', type=str, default='BNCAGAN/results')
    parser.add_argument('--val_label_dir', type=str, default='./fivek/val/label/')
    parser.add_argument('--test_label_dir', type=str, default='./fivek/test/label/')
