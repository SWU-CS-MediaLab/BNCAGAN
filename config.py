...
def get_config():
    ...
    parser.add_argument('--train_batch_size', type=int, default=8, help='mini batch size')
    ...
    parser.add_argument('--lambda_logit', type=float, default=0.10, help='weight for classifier loss')
    ...
    parser.add_argument('--num_epochs_start_val', type=int, default=80, help='start validate the model')
